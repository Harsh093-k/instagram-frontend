...
const ChatPage = () => {
    ...
    const renderChatPanel = () => (
            <section className='flex-1 border-l border-gray-300 flex flex-col h-screen md:h-full'>
                {/* Header */}
                <div className='flex gap-3 items-center px-3 py-2 border-b border-gray-300 sticky top-0 bg-white z-10'>
                    <div>
                ...
                {/* Message Input */}
                <div className='flex items-center p-4 border-t border-gray-300 bg-black bg-white md:static fixed bottom-0 left-0 right-0 z-50'>
                    <Input
                        value={textMessage}
